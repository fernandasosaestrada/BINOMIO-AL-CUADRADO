...
public class Cal extends JFrame implements ActionListener {
    ...
    * Ponemos los atributos de las variables
    ...
    private void iniciarComponentes() {
        ...
        lnumero1.setBounds(100, 280, 200, 20);
        ...
        lresultado.setBounds(100, 480, 200, 20);
        lresultado.setFont(new Font("TimesRoman", Font.BOLD, 18));
        add(lresultado);
        lresultado.setVisible(true);

        lprocedimiento = new JLabel("Procedimiento");
        lprocedimiento.setBounds(100, 380, 200, 20);
        lprocedimiento.setFont(new Font("TimesRoman", Font.BOLD, 18));
        add(lprocedimiento);
        lprocedimiento.setVisible(true);

        //TextFields
        numero1 = new JTextField();
        numero1.setBounds(300, 280, 100, 30);
        numero1.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                char caracter = e.getKeyChar();

                // Verificar si la tecla pulsada no es un digito
                if (((caracter < '0') || (caracter > '9')) && (caracter != '\b' /*corresponde a un espacio en blanco*/)) {
        ...
        resultado.setBounds(300, 480, 100, 30);
        ...
        procedimiento.setBounds(300, 380, 100, 30);
        add(procedimiento);
        procedimiento.setVisible(true);

        //buttons
        Resultado = new JButton("Resultado");
        Resultado.setBounds(450, 320, 100, 50);
        add(Resultado);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Resultado) {
            /**
             * Al dar click en el botón resultado se despliega tanto el
             * resultado como el procedimiento
             */
